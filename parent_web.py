...
if st.session_state.get("theme_mode") == "🌙 Giao diện Tối":
    st.markdown("""
        ...
        * { font-family: 'Be Vietnam Pro', sans-serif !important; }
        .stApp, .main, [data-testid="stAppViewContainer"] {
            background-color: #0a1628 !important; color: #e2e8f0 !important;
        }
        .stMarkdown p, .stMarkdown span, label p, td, th, caption { color: #e2e8f0 !important; }
        [data-testid="stHeader"] { background-color: rgba(10,22,40,0.85) !important; backdrop-filter: blur(12px); }
        section[data-testid="stSidebar"] { background-color: #060e1c !important; border-right: 1px solid rgba(56,189,248,0.1) !important; }
        section[data-testid="stSidebar"] * { color: #94a3b8 !important; }
        section[data-testid="stSidebar"] h1, section[data-testid="stSidebar"] h2, section[data-testid="stSidebar"] h3 {
            color: #38bdf8 !important; -webkit-text-fill-color: #38bdf8 !important; background: none !important;
        }
        h1, h2, h3 {
        ...
        div[data-testid="stVerticalBlockBorderWrapper"] {
            background-color: #0f1e35 !important; border: 1px solid rgba(56,189,248,0.15) !important;
        ...
        div[data-testid="stVerticalBlockBorderWrapper"]:hover {
            ...
            box-shadow: 0 12px 40px rgba(56,189,248,0.1) !important; transform: translateY(-2px) !important;
        }
        [data-testid="stMetric"] { background: #0c1829 !important; border: 1px solid rgba(56,189,248,0.15) !important; border-radius: 14px !important; padding: 1rem 1.2rem !important; }
        ...
        .stTextInput input, .stNumberInput input, .stTextArea textarea {
            background-color: #07101f !important; color: #e2e8f0 !important;
            border: 1px solid rgba(56,189,248,0.25) !important; border-radius: 10px !important; caret-color: #38bdf8 !important;
        }
        .stTextInput input:focus, .stNumberInput input:focus, .stTextArea textarea:focus {
            border-color: #38bdf8 !important; box-shadow: 0 0 0 3px rgba(56,189,248,0.15) !important; outline: none !important;
        }
        .stTextInput input::placeholder, .stTextArea textarea::placeholder { color: #475569 !important; }
        .stTextInput label p, .stNumberInput label p, .stTextArea label p, .stSelectbox label p { color: #94a3b8 !important; font-size: 0.85rem !important; }
        div[data-baseweb="select"] > div { background-color: #07101f !important; border: 1px solid rgba(56,189,248,0.25) !important; border-radius: 10px !important; }
        ...
        .stNumberInput button { background: #0f1e35 !important; border: 1px solid rgba(56,189,248,0.2) !important; color: #e2e8f0 !important; border-radius: 8px !important; }
        button[data-testid="baseButton-primary"] {
            background: linear-gradient(135deg, #ef4444, #dc2626) !important; border: none !important;
            color: #ffffff !important; font-weight: 600 !important; border-radius: 10px !important;
            box-shadow: 0 2px 14px rgba(239,68,68,0.35) !important; transition: all 0.2s ease !important;
        }
        button[data-testid="baseButton-primary"]:hover { box-shadow: 0 4px 22px rgba(239,68,68,0.55) !important; transform: translateY(-1px) !important; }
        button[data-testid="baseButton-secondary"] {
            background: linear-gradient(135deg, #0ea5e9, #6366f1) !important; border: none !important;
            color: #ffffff !important; font-weight: 600 !important; border-radius: 10px !important;
            box-shadow: 0 2px 14px rgba(56,189,248,0.3) !important; transition: all 0.2s ease !important;
        }
        button[data-testid="baseButton-secondary"]:hover { box-shadow: 0 4px 22px rgba(56,189,248,0.5) !important; transform: translateY(-1px) !important; }
        button[data-testid="baseButton-tertiary"] { background: #0f1e35 !important; border: 1px solid rgba(56,189,248,0.2) !important; color: #94a3b8 !important; border-radius: 10px !important; }
        [data-testid="stTabs"] [role="tablist"] { background: #0c1829 !important; border-radius: 12px !important; padding: 4px !important; border: 1px solid rgba(56,189,248,0.12) !important; gap: 3px !important; }
        [data-testid="stTabs"] button[role="tab"] { color: #475569 !important; font-size: 0.83rem !important; font-weight: 500 !important; border-radius: 9px !important; padding: 0.4rem 1rem !important; border: none !important; background: transparent !important; }
        [data-testid="stTabs"] button[role="tab"][aria-selected="true"] { background: linear-gradient(135deg, #0ea5e9, #6366f1) !important; color: #ffffff !important; font-weight: 600 !important; box-shadow: 0 2px 12px rgba(56,189,248,0.3) !important; }
        [data-testid="stDataFrame"] { border: 1px solid rgba(56,189,248,0.15) !important; border-radius: 14px !important; overflow: hidden !important; }
        [data-testid="stExpander"] { background: #0f1e35 !important; border: 1px solid rgba(56,189,248,0.15) !important; border-radius: 14px !important; }
        [data-testid="stExpander"] summary { color: #94a3b8 !important; font-size: 0.88rem !important; padding: 0.75rem 1rem !important; }
        [data-testid="stExpander"] summary p { display: inline-block !important; margin-left: 10px !important; color: #e2e8f0 !important; }
        [data-testid="stAlert"] { border-radius: 12px !important; }
        [data-testid="stAlert"] p { color: inherit !important; }
        [data-testid="stProgressBar"] > div { background: #0c1829 !important; border-radius: 99px !important; height: 8px !important; }
        [data-testid="stProgressBar"] > div > div { background: linear-gradient(90deg, #38bdf8, #818cf8) !important; border-radius: 99px !important; }
        .stCaption p, [data-testid="stCaptionContainer"] p { color: #475569 !important; font-size: 0.78rem !important; }
        hr { border: none !important; border-top: 1px solid rgba(56,189,248,0.1) !important; margin: 1.4rem 0 !important; }
        .chat-box { background-color: #0d1e35 !important; padding: 12px 14px !important; border-radius: 0 12px 12px 0 !important; margin-bottom: 10px !important; border-left: 3px solid #38bdf8 !important; }
    ...
    st.markdown("""
        ...
        @import url('https://fonts.googleapis.com/css2?family=Be+Vietnam+Pro:wght@400;500;600;700&display=swap');
        * { font-family: 'Be Vietnam Pro', sans-serif !important; }
        .stApp, .main, [data-testid="stAppViewContainer"] { background-color: #f0f4f8 !important; color: #0f172a !important; }
        .stMarkdown p, .stMarkdown span, label p, td, th { color: #0f172a !important; }
        [data-testid="stHeader"] { background-color: rgba(240,244,248,0.85) !important; backdrop-filter: blur(12px); }
        section[data-testid="stSidebar"] { background-color: #f1f5f9 !important; border-right: 1px solid #dde3ec !important; }
        section[data-testid="stSidebar"] * { color: #64748b !important; }
        h1, h2, h3 { color: #0284c7 !important; background: none !important; -webkit-text-fill-color: #0284c7 !important; font-weight: 700 !important; }
        div[data-testid="stVerticalBlockBorderWrapper"] { background-color: #ffffff !important; border: 1px solid #dde3ec !important; border-radius: 16px !important; padding: 1.4rem 1.6rem !important; box-shadow: 0 4px 20px rgba(0,0,0,0.06) !important; transition: border-color 0.2s, box-shadow 0.2s, transform 0.2s !important; }
        div[data-testid="stVerticalBlockBorderWrapper"]:hover { border-color: #93c5fd !important; box-shadow: 0 8px 28px rgba(2,132,199,0.1) !important; transform: translateY(-2px) !important; }
        [data-testid="stMetric"] { background: #f8fafc !important; border: 1px solid #dde3ec !important; border-radius: 14px !important; padding: 1rem 1.2rem !important; }
        [data-testid="stMetricLabel"] p { color: #64748b !important; font-size: 0.72rem !important; text-transform: uppercase; letter-spacing: 0.07em; }
        [data-testid="stMetricValue"] { color: #0f172a !important; font-size: 1.6rem !important; font-weight: 700 !important; }
        .stTextInput input, .stNumberInput input, .stTextArea textarea { background-color: #ffffff !important; color: #0f172a !important; border: 1px solid #94a3b8 !important; border-radius: 10px !important; }
        .stTextInput input:focus, .stNumberInput input:focus, .stTextArea textarea:focus { border-color: #0284c7 !important; box-shadow: 0 0 0 3px rgba(2,132,199,0.12) !important; }
        div[data-baseweb="select"] > div { background-color: #ffffff !important; border: 1px solid #94a3b8 !important; border-radius: 10px !important; }
        div[data-baseweb="select"] span { color: #0f172a !important; }
        button[data-testid="baseButton-primary"] { background: linear-gradient(135deg, #ef4444, #dc2626) !important; border: none !important; color: #fff !important; font-weight: 600 !important; border-radius: 10px !important; box-shadow: 0 2px 10px rgba(239,68,68,0.3) !important; }
        button[data-testid="baseButton-secondary"] { background: linear-gradient(135deg, #0284c7, #6366f1) !important; border: none !important; color: #fff !important; font-weight: 600 !important; border-radius: 10px !important; box-shadow: 0 2px 10px rgba(2,132,199,0.25) !important; }
        [data-testid="stTabs"] [role="tablist"] { background: #f1f5f9 !important; border-radius: 12px !important; padding: 4px !important; border: 1px solid #dde3ec !important; }
        [data-testid="stTabs"] button[role="tab"] { color: #64748b !important; background: transparent !important; border-radius: 9px !important; border: none !important; font-size: 0.83rem !important; }
        [data-testid="stTabs"] button[role="tab"][aria-selected="true"] { background: linear-gradient(135deg, #0284c7, #6366f1) !important; color: #fff !important; font-weight: 600 !important; }
        [data-testid="stExpander"] { background: #ffffff !important; border: 1px solid #dde3ec !important; border-radius: 14px !important; }
        [data-testid="stExpander"] summary { color: #0f172a !important; font-size: 0.88rem !important; padding: 0.75rem 1rem !important; }
        [data-testid="stExpander"] summary p { display: inline-block !important; margin-left: 10px !important; color: #0f172a !important; }
        .chat-box { background-color: #f1f5f9 !important; padding: 12px 14px !important; border-radius: 0 12px 12px 0 !important; margin-bottom: 10px !important; border-left: 3px solid #0284c7 !important; color: #0f172a !important; }
...
nav_shadow = "rgba(0,0,0,0.3)"       if is_dark else "rgba(0,0,0,0.08)"
nav_color  = "#475569"
nav_active = "#38bdf8"               if is_dark else "#0284c7"
nav_bar_indicator = "#38bdf8"        if is_dark else "#0284c7"
        ...
        if st.button("Đăng nhập hệ thống 🚀", use_container_width=True, type="primary"):
            ...
            if u and p:
                try:
                    ...
                    st.error("❌ Lỗi kết nối tới Firebase!")
        st.write("---")
...
def call_gemini(prompt: str, system_instruction: str = "") -> str:
    ...
    try:
        ...
        return response.text if response.text else "❌ AI không trả về nội dung."
    except Exception as e:
...
m1, m2 = st.columns(2)
with m1:
    st.metric(label="📡 Máy chủ Firebase", value="Hoạt động tốt 🟢")
with m2:
