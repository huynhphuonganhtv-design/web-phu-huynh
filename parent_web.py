...
NAV_CSS = """
<style>
/* Đẩy nội dung lên để không bị nav che */
.main .block-container {
    padding-bottom: 90px !important;
}

/* Nav container cố định dưới màn hình */
#nav-bar-container {
    position: fixed;
    bottom: 0;
    left: 0;
...
<div id="nav-bar-container">
    <a class="nav-item active" href="#tổng-quan" onclick="setNav(this)">
        <span class="nav-icon">🏆</span>
        <span>Tổng quan</span>
    </a>
    <a class="nav-item" href="#thống-kê-học-tập-chi-tiết" onclick="setNav(this)">
        <span class="nav-icon">📊</span>
        <span>Thống kê</span>
    </a>
    <a class="nav-item" href="#safety-search-guard-giám-sát-bàn-phím-từ-khóa-cấm" onclick="setNav(this)">
        <span class="nav-icon">🛡️</span>
        <span>An toàn</span>
    </a>
    <a class="nav-item" href="#điều-khiển-giao-mục-tiêu-từ-xa" onclick="setNav(this)">
        <span class="nav-icon">⚡</span>
        <span>Điều khiển</span>
    </a>
    <a class="nav-item" href="#trợ-lý-ai-phụ-huynh" onclick="setNav(this)">
        <span class="nav-icon">🤖</span>
        <span>AI</span>
    </a>
    <a class="nav-item" href="#nhật-ký-tin-nhắn-công-cộng" onclick="setNav(this)">
        <span class="nav-icon">💬</span>
        <span>Chat</span>
    </a>
</div>
